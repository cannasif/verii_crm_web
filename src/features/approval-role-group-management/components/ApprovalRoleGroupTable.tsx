...
interface ApprovalRoleGroupTableProps {
  ...
  rowKey: (row: ApprovalRoleGroupDto) => string | number;
  renderCell: (row: ApprovalRoleGroupDto, key: ApprovalRoleGroupColumnKey) => React.ReactNode;
  sortBy: ApprovalRoleGroupColumnKey;
  sortDirection: 'asc' | 'desc';
  onSort: (key: ApprovalRoleGroupColumnKey) => void;
  renderSortIcon: (key: ApprovalRoleGroupColumnKey) => React.ReactNode;
  isLoading?: boolean;
  loadingText?: string;
  errorText?: string;
  emptyText?: string;
  ...
  rowClassName?: string | ((row: ApprovalRoleGroupDto) => string | undefined);
  pageSize: number;
...
export function ApprovalRoleGroupTable({
  ...
  const renderActionsCell = (roleGroup: ApprovalRoleGroupDto): ReactElement => (
