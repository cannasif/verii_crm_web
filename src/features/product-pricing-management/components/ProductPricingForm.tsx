                      ...
                      <FormItem className="space-y-2">
                        ...
                        <div className="flex gap-2">
                          ...
                          <Button
                            ...
                            className="h-11 shrink-0 bg-linear-to-r from-pink-600 to-orange-600 px-6 font-bold text-white shadow-lg shadow-pink-500/20 transition-all duration-300 hover:scale-[1.05] hover:from-pink-500 hover:to-orange-500 active:scale-[0.98] rounded-xl opacity-50 grayscale-[0] dark:opacity-100 dark:grayscale-0"
                          >
        ...
        <DialogFooter className="px-6 sm:px-8 py-2 border-t border-slate-100 dark:border-white/5 shrink-0 flex flex-row items-center justify-between gap-4 backdrop-blur-sm">
          ...
          <div className="flex items-center gap-3">
            ...
            <Button
              ...
              className="h-12 bg-linear-to-r from-pink-600 to-orange-600 px-10 font-black text-white shadow-lg shadow-pink-500/20 ring-1 ring-pink-400/30 transition-all duration-300 hover:scale-[1.05] hover:from-pink-500 hover:to-orange-500 active:scale-[0.98] rounded-2xl"
            >
              {isLoading ? (
                <>
