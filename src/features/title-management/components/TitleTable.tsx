...
interface TitleTableProps {
  ...
  rows: TitleDto[];
  rowKey: (row: TitleDto) => string | number;
  renderCell: (row: TitleDto, key: TitleColumnKey) => React.ReactNode;
  sortBy: TitleColumnKey;
  sortDirection: 'asc' | 'desc';
  onSort: (key: TitleColumnKey) => void;
  renderSortIcon: (key: TitleColumnKey) => React.ReactNode;
  isLoading?: boolean;
  loadingText?: string;
  errorText?: string;
  emptyText?: string;
  ...
  rowClassName?: string | ((row: TitleDto) => string | undefined);
  pageSize: number;
...
export function TitleTable({
  ...
  const renderActionsCell = (title: TitleDto): ReactElement => (
