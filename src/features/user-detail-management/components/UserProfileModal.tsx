        ...
        <div className="flex flex-col md:flex-row w-full h-full overflow-y-auto md:overflow-hidden">
          <div className={cn(
            ...
            <div className="relative group mb-4 md:mb-6 mt-4 md:mt-0">
              ...
              <div className="absolute -bottom-1 -right-1 w-6 h-6 md:w-9 md:h-9 bg-emerald-500 rounded-2xl border-4 border-[#120c18] flex items-center justify-center shadow-lg">
              ...
              <div className={cn(
                ...
                <div className="flex items-center gap-3 md:gap-4">
                  <div className={cn("p-2.5 md:p-4 rounded-2xl shadow-lg", darkMode ? "bg-orange-500/20 text-orange-400" : "bg-orange-100 text-orange-600")}>
                    {darkMode ? <Moon02Icon size={18} className="md:w-6 md:h-6" /> : <Sun01Icon size={18} className="md:w-6 md:h-6" />}
                  </div>
                  <div className="text-left">
