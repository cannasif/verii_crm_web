          ...
          <Form {...form}>
            <form id="product-pricing-group-form" onSubmit={form.handleSubmit(handleSubmit)} className="flex flex-col min-h-0">
              <div className="p-8 space-y-6">
                ...
                {watchedValues[0] > 0 && (
                  <div className="relative overflow-hidden rounded-[2rem] border border-primary/15 bg-accent/35 p-8 space-y-6 dark:bg-primary/5">
                    <div className="relative z-10 flex items-center gap-3 text-xs font-bold uppercase tracking-widest text-primary">
