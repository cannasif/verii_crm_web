...
const getColumnsConfig = (t: TFunction): ColumnDef<PaymentTypeDto>[] => [
    { key: 'id', label: t('paymentTypeManagement.table.id'), type: 'id', className: 'w-[80px]' },
    { key: 'name', label: t('paymentTypeManagement.table.name'), type: 'text', className: 'min-w-[200px] font-medium' },
    { key: 'description', label: t('paymentTypeManagement.table.description'), type: 'text', className: 'min-w-[250px]' },
    { key: 'createdDate', label: t('paymentTypeManagement.createdDate'), type: 'date', className: 'w-[150px]' },
    { key: 'updatedDate', label: t('paymentTypeManagement.updatedDate'), type: 'date', className: 'w-[150px]' },
