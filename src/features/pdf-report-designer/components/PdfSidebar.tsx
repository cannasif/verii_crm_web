...
const TEXT_ITEM: PdfFieldPaletteItem = {
  label: 'Text',
  path: '',
  type: 'text',
};

const ADD_TABLE_ITEM: PdfFieldPaletteItem = {
  label: 'Add Table',
  path: '',
  type: 'table',
};

const LOGO_IMAGE_ITEM: PdfFieldPaletteItem = {
  label: 'Logo Image',
  path: '',
  type: 'image',
  value: 'Logo',
...
export function PdfSidebar({
  ...
  return (
    <div className="flex w-64 flex-col gap-6 border-r border-slate-200 bg-slate-50 p-4 dark:border-slate-700 dark:bg-slate-900/30">
      ...
      <Section title="Text" items={[TEXT_ITEM]} idPrefix="pdf-palette-text" />
      <Section title="Fields" items={fieldsItems} idPrefix="pdf-palette-fields" />
      <Section title="Table Columns" items={tableColumnsItems} idPrefix="pdf-palette-table-columns" />
      ...
      <Section title="Add Table" items={[ADD_TABLE_ITEM]} idPrefix="pdf-palette-add-table" />
      <Section title="Images" items={[LOGO_IMAGE_ITEM]} idPrefix="pdf-palette-images" />
      <TextPropertiesPanel />
