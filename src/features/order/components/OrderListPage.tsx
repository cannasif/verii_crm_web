...
export function OrderListPage(): ReactElement {
  ...
  const renderActionsCell = (order: OrderGetDto): ReactElement => {
    ...
    <DocumentListRowActions
      ...
      showCustomerCancel={canUpdate && canCustomerCancelDocument(resolvedStatus, Boolean(order.isERPIntegrated))}
  ...
  return (
    <div className="relative min-h-0 space-y-3 overflow-hidden animate-in fade-in slide-in-from-bottom-2 duration-700">
