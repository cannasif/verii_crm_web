    ...
    <div className="w-full space-y-6 relative">
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 pt-2">
        ...
        <Button
          ...
          className="px-6 py-2 bg-[image:var(--crm-brand-gradient)] rounded-xl text-white text-sm font-bold shadow-lg shadow-primary/20 hover:scale-105 transition-transform border-0 hover:text-white h-11 opacity-90 grayscale-[0] dark:opacity-100 dark:grayscale-0"
        >
