...
interface ShippingAddressTableProps {
  ...
  rowKey: (row: ShippingAddressDto) => string | number;
  renderCell: (row: ShippingAddressDto, key: ShippingAddressColumnKey) => React.ReactNode;
  sortBy: ShippingAddressColumnKey;
  sortDirection: 'asc' | 'desc';
  onSort: (key: ShippingAddressColumnKey) => void;
  renderSortIcon: (key: ShippingAddressColumnKey) => React.ReactNode;
  isLoading?: boolean;
  loadingText?: string;
  errorText?: string;
  emptyText?: string;
  ...
  rowClassName?: string | ((row: ShippingAddressDto) => string | undefined);
  pageSize: number;
