                ...
                <div className="flex flex-wrap gap-2">
                  {!isConnected ? (
                    <Button
                      ...
                      className="bg-linear-to-r from-pink-600 to-orange-600 text-white font-black hover:scale-[1.05] active:scale-[0.95] transition-all shadow-[0_10px_20px_-10px_rgba(219,39,119,0.5)] rounded-xl opacity-50 grayscale-[0] dark:opacity-100 dark:grayscale-0"
                    >
