...
export const pdfReportTemplateQueryKeys = {
  list: (params?: { pageNumber?: number; pageSize?: number; search?: string; searchFields?: string[]; sortBy?: string; sortDirection?: 'asc' | 'desc'; ruleType?: number; isActive?: boolean }) =>
  ...
  presetList: (params?: { pageNumber?: number; pageSize?: number; search?: string; searchFields?: string[]; sortBy?: string; sortDirection?: 'asc' | 'desc'; ruleType?: number; isActive?: boolean }) =>
