...
export function SystemSettingsPage(): ReactElement {
  ...
  const handleSubmit = async (values: UpdateSystemSettingsDto): Promise<void> => {
    const payload: UpdateSystemSettingsDto = {
      ...
      enableDemandSpecialCodeEditing: values.enableDemandSpecialCodeEditing,
      enableQuotationSpecialCodeEditing: values.enableQuotationSpecialCodeEditing,
      enableOrderSpecialCodeEditing: values.enableOrderSpecialCodeEditing,
