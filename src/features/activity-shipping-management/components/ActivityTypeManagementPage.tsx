...
const PAGE_KEY = 'activity-shipping-management';
...
export function ActivityTypeManagementPage(): ReactElement {
  ...
  const [searchFields, setSearchFields] = usePagedSearchFields(PAGE_KEY, user?.id, ACTIVITY_TYPE_FILTER_COLUMNS);
      ...
      <Card className={MANAGEMENT_LIST_CARD_CLASSNAME}>
        <CardHeader className={MANAGEMENT_LIST_CARD_HEADER_CLASSNAME}>
          ...
          <DataTableActionBar
            ...
            translationNamespace="activity-shipping-management"
            ...
            additionalFilterActions={
              <DefinitionExcelActions
                definitionKey="activity-shipping-definition"
                fileNamePrefix="aktivite-teslimat"
