...
import type { QuotationApprovalFlowReportDto, ApprovalFlowStepReportDto, ApprovalActionDetailDto } from '../types/quotation-types';
...
export function QuotationApprovalFlowTab({ quotationId }: QuotationApprovalFlowTabProps): ReactElement {
  ...
  const dto = report as QuotationApprovalFlowReportDto;
