    ...
    <div className="relative overflow-hidden rounded-none border-0 bg-white/95 dark:bg-zinc-900/50">
      <div className="p-5 sm:p-6">
        <div className="flex items-center gap-2.5 mb-6 text-zinc-900 dark:text-white border-b border-zinc-100 dark:border-white/5 pb-4">
          ...
          <div>
            <h3 className="font-bold text-sm tracking-tight leading-none mb-1">{t('quotation.summary.title')}</h3>
            <span className="text-[10px] text-zinc-400 font-medium uppercase tracking-tighter">{t('quotation.summary.grandTotalAnalysis')}</span>
          </div>
        </div>
        ...
        <div className="mt-6 pt-5 space-y-3.5">
            ...
            <div className="mt-4 pt-5 border-t-2 border-zinc-200 dark:border-zinc-800">
              <div className="flex items-center justify-between gap-3">
                ...
                <span className="font-black font-mono tabular-nums text-right text-lg text-transparent bg-clip-text bg-linear-to-r from-pink-600 to-purple-600">
