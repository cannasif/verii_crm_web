...
const CHECKBOX_CLASSNAME =
  'h-5 w-5 rounded-md border-2 border-slate-300 bg-white shadow-sm transition-all data-[state=checked]:border-pink-500 data-[state=checked]:bg-pink-500 data-[state=checked]:text-white dark:border-white/25 dark:bg-white/[0.04] dark:data-[state=checked]:border-pink-500 dark:data-[state=checked]:bg-pink-500';
      ...
      <div
        className={cn(
          ...
          allSelected || someSelected
            ? 'border-pink-200/80 bg-pink-50/80 dark:border-pink-500/30 dark:bg-pink-500/10'
            ...
            return (
              <div
                ...
                className={cn(
                  ...
                  isChecked
                    ? 'border-pink-300/80 bg-pink-500/10 shadow-sm dark:border-pink-500/35 dark:bg-pink-500/12'
              ...
              >
                ...
                <label htmlFor={`group-${item.id}`} className="flex min-w-0 flex-1 cursor-pointer items-center gap-2">
                  ...
                  <span className="min-w-0 flex-1">
                    <span className={cn('block text-sm font-semibold', isChecked ? 'text-pink-900 dark:text-pink-100' : 'text-slate-800 dark:text-slate-100')}>
                      {item.name}
                    </span>
                    {item.description && (
