...
export function DemandHeaderForm({
  ...
  const watchedShippingAddressId = form.watch('demand.shippingAddressId');
  ...
  const styles = {
    ...
    inputBase: "h-11 bg-white dark:bg-[#0f0a18] border-slate-400/75 dark:border-white/16 rounded-xl shadow-sm transition-all duration-300 focus:ring-4 focus:ring-primary/20 focus:border-primary outline-none w-full",
    ...
    selectTrigger: "w-full h-11 bg-white dark:bg-[#0f0a18] border-slate-500/80 dark:border-white/22 hover:border-primary/40 dark:hover:border-white/30 transition-all shadow-[0_1px_0_rgba(15,23,42,0.05),0_6px_14px_-10px_rgba(15,23,42,0.35)] rounded-xl focus:ring-4 focus:ring-primary/20 focus:border-primary outline-none text-slate-800 dark:text-slate-100",
  ...
  const getIconTone = (hasValue: boolean): string =>
    hasValue ? 'text-primary' : 'text-slate-400 group-focus-within:text-primary';
                ...
                <div className="xl:col-span-2 space-y-2">
                  ...
                  <div className="flex gap-2">
                    <div className="relative flex-1 group min-w-0">
                      <div className={cn("absolute left-3 top-1/2 -translate-y-1/2 z-10 pointer-events-none transition-colors", customerSearchQuery?.trim() ? "text-primary" : "text-slate-400 group-focus-within:text-primary")}>
                        <Search className="h-4 w-4" />
                      </div>
                      <FormControl>
                        <Input
                          className={cn(styles.inputBase, "pl-10 font-medium truncate caret-primary")}
                                  ...
                                  <CommandItem
                                    ...
                                    className={cn(
                                      ...
                                      customerKeyboard.isOptionKeyboardActive(index) &&
                                        'ring-2 ring-primary ring-offset-2 ring-offset-white dark:ring-offset-[#0f0a18]',
                                    )}
                                  >
                    ...
                    <Button
                      ...
                      className="h-11 w-11 shrink-0 rounded-xl border-slate-200 dark:border-white/10 hover:bg-primary hover:border-primary hover:text-primary-foreground transition-all duration-300 shadow-sm"
                      disabled={readOnly}
                    >
                    ...
                    <div className="relative">
                      ...
                      <FormControl>
                        <VoiceSearchCombobox
                          ...
                          placeholder={t('select')}
                          className={cn(styles.selectTrigger, "min-w-0 pl-10 hover:border-primary/40 dark:hover:border-white/20 focus:ring-4 focus:ring-primary/20 focus:border-primary")}
                          popoverContentClassName="md:min-w-[var(--radix-popover-trigger-width)] md:w-auto md:max-w-[400px]"
                        />
                      </FormControl>
                    </div>
                    ...
                    <FormItem className="space-y-0 relative group w-full min-w-0">
                      ...
                      <div className="relative w-full min-w-0">
                        ...
                        <FormControl>
                          <Input 
                            type="date" 
                            className={cn(styles.inputBase, "pl-10 text-xs sm:text-sm font-medium bg-white dark:bg-[#0f0a18] border-slate-200 dark:border-white/10 shadow-sm focus-visible:ring-4 focus-visible:ring-primary/20 focus-visible:border-primary")} 
                            {...field}
