...
export function normalizeSystemSettings(
  ...
  return {
    ...
    enableDemandSpecialCodeEditing: settings?.enableDemandSpecialCodeEditing !== false,
    enableQuotationSpecialCodeEditing: settings?.enableQuotationSpecialCodeEditing !== false,
    enableOrderSpecialCodeEditing: settings?.enableOrderSpecialCodeEditing !== false,
