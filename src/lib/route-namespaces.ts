const ROUTE_NAMESPACE_ENTRIES: Array<{ match: (pathname: string) => boolean; namespaces: string[] }> = [
  ...
  { match: (pathname) => pathname.startsWith('/demands'), namespaces: ['demand', 'approval', 'report-designer', 'stock', 'windo-profil-demir-vida-management'] },
  { match: (pathname) => pathname.startsWith('/orders'), namespaces: ['order', 'approval', 'google-integration', 'report-designer', 'stock', 'windo-profil-demir-vida-management'] },
