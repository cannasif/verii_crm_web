const ROUTE_NAMESPACE_ENTRIES: Array<{ match: (pathname: string) => boolean; namespaces: string[] }> = [
  ...
  { match: (pathname) => pathname.startsWith('/customer-management'), namespaces: ['customer-management', 'activity-management'] },
  ...
  { match: (pathname) => pathname.startsWith('/contact-management'), namespaces: ['contact-management', 'activity-management'] },
  ...
  { match: (pathname) => pathname.startsWith('/quotations'), namespaces: ['quotation', 'approval', 'google-integration', 'report-designer', 'stock'] },
  { match: (pathname) => pathname.startsWith('/demands'), namespaces: ['demand', 'approval', 'report-designer', 'stock'] },
  { match: (pathname) => pathname.startsWith('/orders'), namespaces: ['order', 'approval', 'google-integration', 'report-designer', 'stock'] },
