const ROUTE_NAMESPACE_ENTRIES: Array<{ match: (pathname: string) => boolean; namespaces: string[] }> = [
  ...
  { match: (pathname) => pathname.startsWith('/sales-planning/forecast'), namespaces: ['sales-planning', 'sales-forecast'] },
  { match: (pathname) => pathname.startsWith('/sales-planning'), namespaces: ['sales-planning'] },
  ...
  { match: (pathname) => pathname.startsWith('/customer-360'), namespaces: ['customer360', 'customer-management', 'activity-management', 'google-integration', 'outlook-integration', 'sales-planning', 'sales-forecast'] },
  { match: (pathname) => pathname.startsWith('/salesmen-360'), namespaces: ['sales-planning', 'sales-forecast'] },
