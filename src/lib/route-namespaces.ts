const ROUTE_NAMESPACE_ENTRIES: Array<{ match: (pathname: string) => boolean; namespaces: string[] }> = [
  ...
  { match: (pathname) => pathname.startsWith('/quotations'), namespaces: ['quotation', 'approval', 'google-integration', 'report-designer'] },
  { match: (pathname) => pathname.startsWith('/demands'), namespaces: ['demand', 'approval', 'report-designer'] },
  { match: (pathname) => pathname.startsWith('/orders'), namespaces: ['order', 'approval', 'google-integration', 'report-designer'] },
